...
#define IDS_MBLD_SUB            L"查看所有房屋(&V)"
...
#define IDS_DLGROM_ARE          L"面积(平方米)："
#define IDS_DLGROM_PRI          L"价格(元/平方米)："
